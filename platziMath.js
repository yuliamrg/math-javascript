...
platziMath.calculateMode = function(array) {
    const listaCount = {};
...
platziMath.itsEven = function(array) {
    return !(array.length % 2);
}
platziMath.sortList = function(unorderedlist) {
    const list = unorderedlist.sort((a, b) => a - b );

    return list;
}
platziMath.sortListBidimensional = function(unorderedlist, i) {
